...
4. Blog Update Panel of Marketo Connector. This is where we set options on what the plugin does whenever a new post is made.
Leads in marketo may receive emails informing them that a new post is made. Available on the premium edition only.
